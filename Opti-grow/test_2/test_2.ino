...
HardwareSerial RS485Serial(1); // Use hardware serial port 1 (usually UART1)
...
float readNPK() {
  if (RS485Serial.available()) {
    ...
    int value = RS485Serial.read(); // Adjust as necessary based on your sensor's communication protocol
    if (value == 0 || value >= 4095) {
  ...
  Serial.println("No data available from NPK sensor.");
  return -1;
}
...
void setup() {
  ...
  RS485Serial.begin(9600, SERIAL_8N1, 16, 17); // RX: GPIO 16, TX: GPIO 17
